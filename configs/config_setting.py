...
class setting_config:
    ...
    if opt == 'Adadelta':
        lr = 0.001 # default: 1.0 – coefficient that scale delta before it is applied to the parameters
        ...
        lr = 0.0001 # default: 1e-2 – learning rate
    ...
    if sch == 'StepLR':
        ...
        eps = 1e-08 # – Minimal decay applied to lr. If the difference between new and old lr is smaller than eps,
